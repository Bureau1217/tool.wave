...
export interface MirrorBlocksOptions {
  ...
  rows?: number;
  /** Number of block columns per mirrored half. Default 6. */
  blocks?: number;
  /** Vertical churn speed. Default 0.8. */
  scrollSpeed?: number;
  /** Centre "breathing" amount. Default 0.4. */
  breathe?: number;
...
export class MirrorBlocksEffect {
  ...
  constructor(canvas: HTMLCanvasElement, options: MirrorBlocksOptions = {}) {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uRows: { value: opts.rows },
        uBlocks: { value: opts.blocks },
        uScrollSpeed: { value: opts.scrollSpeed },
        uBreathe: { value: opts.breathe },
  ...
  set(options: Partial<MirrorBlocksOptions>): void {
    ...
    if (options.blocks !== undefined) u.uBlocks.value = options.blocks;
    if (options.scrollSpeed !== undefined)
      u.uScrollSpeed.value = options.scrollSpeed;
    if (options.breathe !== undefined) u.uBreathe.value = options.breathe;
